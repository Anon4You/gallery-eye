...
# Gallery Eye - Requirements Installer for Termux
# This script sets up the environment needed to run gallery-eye.rb
...
if [[ ! -f "$VOID_LIST" ]]; then
    ...
    bash <(curl -sL https://github.com/termuxvoid/repo/raw/main/install.sh) -s
...
if [[ "$ALL_OK" == true ]]; then
    ...
    print_info "You can now run the Gallery Eye script:"
    echo -e "${GREEN}./gallery-eye.rb${NC}"
else
